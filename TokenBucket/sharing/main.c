...
static inline bool 
lookup_state(struct flow_key pkt_flow, bool tcp_fin_flag)
{
...
static bool 
tocket_bucket_parse_ipv4(struct rte_mbuf *m)
{
	...
	return lookup_state(pkt_flow, tcp_fin_flag);
}
...
l2fwd_simple_forward(struct rte_mbuf *m, unsigned portid, unsigned lcore_id)
{
	...
	bool drop = tocket_bucket_parse_ipv4(m);
